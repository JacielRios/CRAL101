<div class="d-flex justify-content-center">
    <button class="btn btn-outline-danger fs-4 d-none d-md-block " wire:click="$emit('triggerDelete',{{ $postId }})"> 
        Eliminar
    </button>
    <button class="btn btn-outline-danger d-md-none " wire:click="$emit('triggerDelete',{{ $postId }})"> 
        Eliminar
    </button>
</div>
@push('scripts')
