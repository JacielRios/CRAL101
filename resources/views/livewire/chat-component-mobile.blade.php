<section>
    ...
    <div x-data="data()" class="shadow border overflow-hidden ms-lg-5 me-lg-5 " id="color-gray_50">
                    ...
                    @if ($contactChat || $chat)
                        <div class="py-2 ps-0 border-right pe-0 d-flex align-items-center border-bottom"
                            ...
                            <div class="ms-2">
                                ...
                                @if ($this->active)
                                    <p class="fw-bold m-0" x-show="chat_id != typingChatId" id="online">
                                        En línea
                                    </p>
                                @else
                                    <p class="fw-bold m-0" x-show="chat_id != typingChatId" id="offline">
                                        Desconectado
                                    </p>
                                @endif
                            </div>
                        ...
                        <div class="overflow-auto" id="message-container_mobile">
                            @foreach ($this->messages as $message)
                                <div
                                    ...
                                    @if ($message->user_id == auth()->id())
                                        <div class="rounded px-3 py-2  text-break" style="max-width: 50%;" id="color-send">
                                            <p class="m-0 ">
                                                {{ $message->body }}
                                            </p>
                                    ...
                                    @else
                                        <div class="rounded px-1 py-1 text-break" style="max-width: 50%;"
                                            id="color-received">
                                            <p class="m-0 ">
                                                {{ $message->body }}
                                            </p>
                                            ...
                                            <li class="pe-auto list-group-item list-group-item-action pe-1 ps-1"
                                                ...
                                                <div class="d-flex align-items-center ">
                                                    ...
                                                    <div class="" id="flex-1">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div>
                                                                <p class="fs-6 fw-bold m-0 text-break">
                                                                    {{ $chatItem->name }}
                                                                </p>
