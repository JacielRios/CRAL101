      ...
      <main>
        <section class="container mt-3 mb-3 col-12 d-lg-none">
            <div class="card border-dark">
                <div class="card-header fw-bold">Editar publicación</div>
                <div class="card-body">
                    <form 
                        action="{{ route('home.update', $post) }}"
                        method="POST" 
            ...
            <div class="card-body">
                ...
                >
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control fs-3" required value="{{ old('title', $post->title) }}">
                    </div>
                    <div class="form-group">
                        <label class="fs-3 fw-bold">Contenido *</label>
                        <textarea name="body" rows="6" class="form-control fs-3" required>{{ old('body', $post->body) }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="mt-2 text-end">
                        @csrf
                        @method('PUT')
                        <input type="submit" value="Actualizar" class="btn fs-3 col-1" id="btn-color">
                    </div>
                </form>
            </div>
        </div>
