        ...
        <div class="card-body">
            <form
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="course" class="form-control fs-3" required>
                    </div>
                  </div>
                </div>
                <div class="form-group">
                    <label class="fs-3 fw-bold">Contenido *</label>
                    <textarea name="body" rows="4" class="form-control fs-3" required></textarea>
                </div>
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control fs-3" required>
                </div>
                <div class="container-input ">
