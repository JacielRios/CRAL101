...
<body>
    ...
    <main>
        ...
        <section class="container col-lg-7 mt-5 bg-white fs-2 ps-5 pt-2 pb-3 pe-5 d-none d-lg-block" id="contact-container">
            <form class="pb-3" action="{{ route('contacts.update', $contact) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="mb-3 pt-3">
                    <label for="name" class="form-label">Nombre del contacto</label>
                    <input type="text" class="form-control fs-3" id="name" name="name" value="{{ old('name', $contact->name) }}"
                        placeholder="Ingrese el nombre del contacto" required>
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Correo electronico</label>
                    <input type="email" class="form-control fs-3" id="email" name="email" value="{{ old('email', $contact->user->email) }}"
                        placeholder="Ingrese el correo del contacto" required>
                </div>
                <div class="text-end">
                    <input type="submit" class="btn fs-4" id="btn-color" value="Actualizar contacto" />
                </div>
            </form>
            @if ($errors->any())
        ...
        <section class="container col-11 bg-white pt-2 pb-3 d-lg-none" id="contact-container">
            <form class="pb-3" action="{{ route('contacts.update', $contact) }}" method="POST">
                @method('PUT')
                @csrf
                <div class="mb-3 pt-3">
                ...
                <div class="mb-3">
                    <label for="email" class="form-label">Correo electronico</label>
                    <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $contact->user->email) }}"
                        placeholder="Ingrese el correo del contacto" required>
                </div>
                <div class="text-end">
                    <input type="submit" class="btn" id="btn-color" value="Actualizar contacto" />
                </div>
            </form>
            @if ($errors->any())
                <div class="alert alert-danger">
